...
First push from origin/master 6d3a749 to c7c5a38 included earlier TASK-027/032 changes. The formatting gate correctly rejected unformatted supported files in that full range. Apply formatting only to that range's eligible text files; preserve content, assertions, generated/artifact bytes and behavior. Do not change the gate or suppress failures. Reverify and push the TASK-034 formatting correction under the owner's explicit origin/master approval. Task-033 dependency work stays separate.
