# TASK-008 — Implement consultation notes and amendments
Status: Completed — development MVP only
Requirements: [REQ-FEAT-004](../../Requirements/Features/REQ-FEAT-004.md) v0.1 AC-01–AC-03

## Objective
Implement consultation notes and amendments, satisfying the linked requirement criteria.

## Scope
Implement approved note format, draft save, finalization, amendment and concurrency feedback.
...
## Expected code areas
consultation note domain/use cases/adapters, clinical-app note editor, contracts/migrations (proposed paths; no application files exist yet).
...
- Required justification before implementation: `Doc/Changes/Justification/TASK-008-change.md`.
...
Acceptance: [verification and review](../../Acceptance/TASK-008-acceptance.md). Branch: task/TASK-002-development-mvp. Implementation owner commits: 3194f5e, 55cf441; verification/evidence follows in the session completion commit.
