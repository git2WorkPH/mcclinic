# TASK-020 — Tenant isolation and practice membership
Status: Completed — v0.3 development SaaS.
Requirement: REQ-FOUND-010, AC-01–04.
...
## Dependencies / ADR
Completed MVP; ADR-006 required/accepted for scoped development decisions.
## Branch / rationale
Integrated ordered branch task/TASK-020-saas-practices from 6be71e2. Local/live remote search found no TASK-020–023 branch. Rationale: Doc/Changes/Justification/TASK-020-saas.md.

## Completion — 2026-09-12
Owner approval above preserved. [Acceptance](../../Acceptance/TASK-020-acceptance.md) and [shared verification](../../Acceptance/SAAS-VERIFICATION.md) record evidence and production limits. No live billing/deployment/push. Next: local synthetic UAT; real payment TASK-024 remains Proposed.
